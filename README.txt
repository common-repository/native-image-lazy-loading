...
In version 1.0 there wan't one, but thanks to a suggestion by [@verlok](https://github.com/verlok), there IS one in v1.1.  You'll find it at **Settings** >> **Native Lazy Loading**. 
